...
def menu_loop(surface):
    background = pygame.image.load(os.path.join("C:/or_resource/OrcRaid.png")).convert()
...
def menu_show(surface):
    f = open("C:/or_resource/score.txt", 'r')
...
def game_loop(surface):
    ...
    for img in asteroid_list:
        asteroid_image.append(pygame.image.load(os.path.join("C:/or_resource", img)).convert())
    bullet_image = pygame.image.load(os.path.join("C:/or_resource/Bullet.png")).convert()
...
def update_best_score():
    ...
    if(best_score < score):
        ...
        f = open('C:/or_resource/score.txt', 'w')
        f.truncate()
        f.write(best_score)
